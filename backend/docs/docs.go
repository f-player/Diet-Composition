...
const docTemplate = `{
    ...
    "paths": {
        ...
        "/diet/draft/products/{product_id}": {
            "post": {
                "security": [
                    {
                        "ApiKeyAuth": []
            ...
            "put": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/ds.DietUpdateRequest"
                        }
                    }
                ],
                "responses": {
            ...
            "put": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/ds.ProductToDietUpdateRequest"
                        }
                    }
                ],
                "responses": {
            ...
            "put": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/ds.DietResolveRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "ds.DietDTO": {
            ...
            "properties": {
                ...
                "products": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/ds.ProductInDietDTO"
                    }
                },
                "status": {
                    "type": "integer"
